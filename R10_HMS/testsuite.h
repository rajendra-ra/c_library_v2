...
static void mavlink_test_r10_vsens_err(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_R10_VSENS_ERR >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_r10_vsens_err_t packet_in = {
        93372036854775807ULL,17651,17755,17859,17963,18067,18171,18275,18379,18483,18587,18691,18795,18899,19003
    };
    mavlink_r10_vsens_err_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.TIME_US = packet_in.TIME_US;
        packet1.error_bitmask = packet_in.error_bitmask;
        packet1.VSEN_BUCK1 = packet_in.VSEN_BUCK1;
        packet1.VSEN_BUCK2 = packet_in.VSEN_BUCK2;
        packet1.VSEN_BUCK3 = packet_in.VSEN_BUCK3;
        packet1.VSEN_BUCK4 = packet_in.VSEN_BUCK4;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_R10_VSENS_ERR_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_R10_VSENS_ERR_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_vsens_err_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_r10_vsens_err_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_vsens_err_pack(system_id, component_id, &msg , packet1.TIME_US , packet1.error_bitmask , packet1.VSEN_BUCK1 , packet1.VSEN_BUCK2 , packet1.VSEN_BUCK3 , packet1.VSEN_BUCK4 , packet1.VSEN_BUCK6 , packet1.VSEN_BUCK_S_AUX , packet1.VSEN_28IPS , packet1.VSEN_12IPS , packet1.VSEN_5IPS , packet1.VSEN_OSB , packet1.VSEN_OBB , packet1.AUX_PIX_VOLT , packet1.STM_IN_VOLT );
    mavlink_msg_r10_vsens_err_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_vsens_err_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.TIME_US , packet1.error_bitmask , packet1.VSEN_BUCK1 , packet1.VSEN_BUCK2 , packet1.VSEN_BUCK3 , packet1.VSEN_BUCK4 , packet1.VSEN_BUCK6 , packet1.VSEN_BUCK_S_AUX , packet1.VSEN_28IPS , packet1.VSEN_12IPS , packet1.VSEN_5IPS , packet1.VSEN_OSB , packet1.VSEN_OBB , packet1.AUX_PIX_VOLT , packet1.STM_IN_VOLT );
    mavlink_msg_r10_vsens_err_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_r10_vsens_err_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_vsens_err_send(MAVLINK_COMM_1 , packet1.TIME_US , packet1.error_bitmask , packet1.VSEN_BUCK1 , packet1.VSEN_BUCK2 , packet1.VSEN_BUCK3 , packet1.VSEN_BUCK4 , packet1.VSEN_BUCK6 , packet1.VSEN_BUCK_S_AUX , packet1.VSEN_28IPS , packet1.VSEN_12IPS , packet1.VSEN_5IPS , packet1.VSEN_OSB , packet1.VSEN_OBB , packet1.AUX_PIX_VOLT , packet1.STM_IN_VOLT );
    mavlink_msg_r10_vsens_err_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_r10_isens_err(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_R10_ISENS_ERR >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_r10_isens_err_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_R10_ISENS_ERR_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_R10_ISENS_ERR_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_isens_err_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_r10_isens_err_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_isens_err_pack(system_id, component_id, &msg , packet1.TIME_US , packet1.error_bitmask , packet1.ISEN_S1 , packet1.ISEN_S2 , packet1.ISEN_S3 , packet1.ISEN_S4 , packet1.ISEN_S6 , packet1.ISEN_S_AUX , packet1.ISEN_28IPS , packet1.ISEN_12IPS , packet1.ISEN_5IPS , packet1.ISENS_OSB , packet1.ISENS_OBB );
    mavlink_msg_r10_isens_err_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_isens_err_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.TIME_US , packet1.error_bitmask , packet1.ISEN_S1 , packet1.ISEN_S2 , packet1.ISEN_S3 , packet1.ISEN_S4 , packet1.ISEN_S6 , packet1.ISEN_S_AUX , packet1.ISEN_28IPS , packet1.ISEN_12IPS , packet1.ISEN_5IPS , packet1.ISENS_OSB , packet1.ISENS_OBB );
    mavlink_msg_r10_isens_err_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_r10_isens_err_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_isens_err_send(MAVLINK_COMM_1 , packet1.TIME_US , packet1.error_bitmask , packet1.ISEN_S1 , packet1.ISEN_S2 , packet1.ISEN_S3 , packet1.ISEN_S4 , packet1.ISEN_S6 , packet1.ISEN_S_AUX , packet1.ISEN_28IPS , packet1.ISEN_12IPS , packet1.ISEN_5IPS , packet1.ISENS_OSB , packet1.ISENS_OBB );
    mavlink_msg_r10_isens_err_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_r10_temp_err(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_R10_TEMP_ERR >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_r10_temp_err_t packet_in = {
        93372036854775807ULL,17651,163,230,41,108,175,242,53,120,187,254,65,132
    };
    mavlink_r10_temp_err_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.TIME_US = packet_in.TIME_US;
        packet1.error_bitmask = packet_in.error_bitmask;
        packet1.S1_TEMP = packet_in.S1_TEMP;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_R10_TEMP_ERR_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_R10_TEMP_ERR_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_temp_err_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_r10_temp_err_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_temp_err_pack(system_id, component_id, &msg , packet1.TIME_US , packet1.error_bitmask , packet1.S1_TEMP , packet1.S2_TEMP , packet1.S3_TEMP , packet1.S4_TEMP , packet1.S5_TEMP , packet1.S6_TEMP , packet1.PMU_TEMP , packet1.SG_TEMP , packet1.OSB_TEMP , packet1.OBB_TEMP , packet1.ENG_TEMP1 , packet1.ENG_TEMP2 );
    mavlink_msg_r10_temp_err_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_temp_err_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.TIME_US , packet1.error_bitmask , packet1.S1_TEMP , packet1.S2_TEMP , packet1.S3_TEMP , packet1.S4_TEMP , packet1.S5_TEMP , packet1.S6_TEMP , packet1.PMU_TEMP , packet1.SG_TEMP , packet1.OSB_TEMP , packet1.OBB_TEMP , packet1.ENG_TEMP1 , packet1.ENG_TEMP2 );
    mavlink_msg_r10_temp_err_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_r10_temp_err_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_r10_temp_err_send(MAVLINK_COMM_1 , packet1.TIME_US , packet1.error_bitmask , packet1.S1_TEMP , packet1.S2_TEMP , packet1.S3_TEMP , packet1.S4_TEMP , packet1.S5_TEMP , packet1.S6_TEMP , packet1.PMU_TEMP , packet1.SG_TEMP , packet1.OSB_TEMP , packet1.OBB_TEMP , packet1.ENG_TEMP1 , packet1.ENG_TEMP2 );
    mavlink_msg_r10_temp_err_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_R10_HMS(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_r10_vsens_err(system_id, component_id, last_msg);
    mavlink_test_r10_isens_err(system_id, component_id, last_msg);
    mavlink_test_r10_temp_err(system_id, component_id, last_msg);
}
