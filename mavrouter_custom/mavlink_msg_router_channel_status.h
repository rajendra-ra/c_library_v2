...
#define MAVLINK_MSG_ID_ROUTER_CHANNEL_STATUS 11075
...
#define MAVLINK_MSG_ID_11075_LEN 3
#define MAVLINK_MSG_ID_11075_MIN_LEN 3

#define MAVLINK_MSG_ID_ROUTER_CHANNEL_STATUS_CRC 27
#define MAVLINK_MSG_ID_11075_CRC 27
