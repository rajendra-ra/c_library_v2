...
static void mavlink_test_bms_aux_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_bms_aux_data_t packet1, packet2;
        ...
        packet1.Wind_velocity = packet_in.Wind_velocity;
