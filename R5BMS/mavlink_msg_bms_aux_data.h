...
#define MAVLINK_MSG_ID_BMS_AUX_DATA_CRC 224
#define MAVLINK_MSG_ID_11069_CRC 224
...
#define MAVLINK_MESSAGE_INFO_BMS_AUX_DATA { \
    ...
    {  { "aux_current", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_bms_aux_data_t, aux_current) }, \
         ...
         { "Motor1_temp", NULL, MAVLINK_TYPE_UINT16_T, 0, 24, offsetof(mavlink_bms_aux_data_t, Motor1_temp) }, \
         { "Motor2_temp", NULL, MAVLINK_TYPE_UINT16_T, 0, 26, offsetof(mavlink_bms_aux_data_t, Motor2_temp) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_BMS_AUX_DATA { \
                               ...
                               uint16_t aux_current, uint16_t aux_voltage, uint16_t BMS_current1, uint16_t BMS_current2, uint16_t BMS_current3, uint16_t BMS_voltage, uint16_t BMS_temperature1, uint16_t BMS_temperature2, uint16_t BMS_temperature3, uint16_t BMS_temperature4, uint16_t BMS_cout, uint16_t BMS_dout, uint16_t Motor1_temp, uint16_t Motor2_temp)
{
    ...
    _mav_put_uint16_t(buf, 24, Motor1_temp);
    _mav_put_uint16_t(buf, 26, Motor2_temp);
