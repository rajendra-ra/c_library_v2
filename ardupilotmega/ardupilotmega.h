...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_DO_SPRAYER=216, /* Control attached liquid sprayer |Sprayer Enable.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
